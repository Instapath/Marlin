...
#define HOMING_BACKOFF_POST_MM { 38, 38, 2 }  // (mm) Backoff from endstops after homing
...
#define JOYSTICK
#if ENABLED(JOYSTICK)
  #define JOY_X_PIN    PA3
  #define JOY_Y_PIN   PA2
  #define JOY_Z_PIN   PA1
  #define JOY_EN_PIN  PC14
  ...
  #define JOY_X_LIMITS { 5, 8300-100, 8300+100, 16367 } // min, deadzone start, deadzone end, max
  #define JOY_Y_LIMITS { 5, 9300-100, 9300+100, 16367 }
  #define JOY_Z_LIMITS { 5, 8100-100, 8100+100, 16367 }
